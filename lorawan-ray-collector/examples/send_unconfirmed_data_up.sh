...
# Synthetic LoRaWAN UnconfirmedDataUp:
#   DevAddr: 26011ABC
#   FCnt:    12345 (16-bit value carried over the air)
#   FOpts:   0304 (raw over-the-air bytes)
#   FPort:   10
#   FRMPayload: AABB (encrypted bytes; synthetic in this example)
#   ADR:     true
#   MIC:     11223344 (present but not cryptographically valid)
payload = {
    "rxpk": [{
        "jver": 2,
        "time": "2026-08-25T12:00:04.000000Z",
        "tmst": 3512348514,
        "freq": 865.4,
        "stat": 1,
        "modu": "LR-FHSS",
